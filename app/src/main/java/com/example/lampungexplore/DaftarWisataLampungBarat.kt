...
@Composable
fun lambarlistApp(navController: NavHostController) {
...
@Composable
fun DaftarWisataLampungBaratScreen(navController: NavController) {
    ...
    Surface(
        ...
        Column(
            ...
            Text(
                text = "Daftar Wisata di Lampung Barat",
                fontSize = 24.sp,
            ...
            LazyColumn {
                items(wisataList) { wisata ->
                    WisataItemlambar(wisata = wisata, navController = navController)
                }
            }
        }
    }
...
@Composable
fun WisataItemlambar(wisata: Wisata, navController: NavController) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
...
@Composable
fun DeskripsiWisatalambarScreen(
    nama: String,
    deskripsi: String,
    hargaTiket: String,
    images: List<Int>,
...
@Composable
fun MapsScreenlambar(googleMapsUrl: String) {
    // Display the map screen using the provided URL
    AndroidView(
        factory = { context ->
