...
@Composable
fun mesujilistApp(navController: NavHostController) {
...
@Composable
fun DaftarWisataMesujiScreen(navController: NavController) {
        ...
        Column(
            ...
            LazyColumn {
                items(wisataList) { wisata ->
                    WisataItemmesuji(wisata = wisata, navController = navController)
                }
            }
        }
    }
...
@Composable
fun WisataItemmesuji(wisata: Wisata, navController: NavController) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
...
@Composable
fun DeskripsiWisatamesujiScreen(
    nama: String,
    deskripsi: String,
    hargaTiket: String,
    images: List<Int>,
...
@Composable
fun MapsScreenmesuji(googleMapsUrl: String) {
    // Display the map screen using the provided URL
    AndroidView(
        factory = { context ->
