...
@Composable
fun pesibarlistApp(navController: NavHostController) {
...
@Composable
fun DaftarWisataPesisirBaratScreen(navController: NavController) {
        ...
        Column(
            ...
            LazyColumn {
                items(wisataList) { wisata ->
                    WisataItempesibar(wisata = wisata, navController = navController)
                }
            }
        }
    }
...
@Composable
fun WisataItempesibar(wisata: Wisata, navController: NavController) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
            ...
            .clickable {
                ...
                val route = "DeskripsiWisatapesibarScreen/$encodedNama/$encodedDeskripsi/$imagesString/$encodedHargaTiket/$encodedGoogleMapsUrl"
                navController.navigate(route)
            },
...
@Composable
fun DeskripsiWisatapesibarScreen(
    nama: String,
    deskripsi: String,
    hargaTiket: String,
    images: List<Int>,
...
@Composable
fun MapsScreenpesibar(googleMapsUrl: String) {
    // Display the map screen using the provided URL
    AndroidView(
        factory = { context ->
