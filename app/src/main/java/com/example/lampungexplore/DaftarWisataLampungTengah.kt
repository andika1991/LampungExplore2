...
@Composable
fun lamtenglistApp(navController: NavHostController) {
...
@Composable
fun DaftarWisataLampungTengahScreen(navController: NavController) {
...
@Composable
fun WisataItemlamteng(wisata: Wisata, navController: NavController) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
...
@Composable
fun DeskripsiWisatalamtengScreen(
    nama: String,
    deskripsi: String,
    hargaTiket: String,
    images: List<Int>,
...
@Composable
fun MapsScreenlamteng(googleMapsUrl: String) {
    // Display the map screen using the provided URL
    AndroidView(
        factory = { context ->
