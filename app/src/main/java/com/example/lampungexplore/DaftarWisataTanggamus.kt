...
@Composable
fun tgmslistApp(navController: NavHostController) {
...
@Composable
fun DaftarWisataTanggamusScreen(navController: NavController) {
        ...
        Column(
            ...
            LazyColumn {
                items(wisataList) { wisata ->
                    WisataItemtgms(wisata = wisata, navController = navController)
                }
            }
        }
    }
...
@Composable
fun WisataItemtgms(wisata: Wisata, navController: NavController) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
...
@Composable
fun MapsScreentgms(googleMapsUrl: String) {
    // Display the map screen using the provided URL
    AndroidView(
        factory = { context ->
