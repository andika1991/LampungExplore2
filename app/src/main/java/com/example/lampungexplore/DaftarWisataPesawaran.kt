...
@Composable
fun pesawaranlistApp(navController: NavHostController) {
...
@Composable
fun DaftarWisataPesawaranScreen(navController: NavController) {
    ...
    Surface(
        ...
        Column(
            ...
            Text(
                text = "Daftar Wisata di Pesawaran",
                fontSize = 24.sp,
            ...
            LazyColumn {
                items(wisataList) { wisata ->
                    WisataItempesawaran(wisata = wisata, navController = navController)
                }
            }
        }
    }
...
@Composable
fun WisataItempesawaran(wisata: Wisata, navController: NavController) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
...
@Composable
fun DeskripsiWisatapesawaranScreen(
    nama: String,
    deskripsi: String,
    hargaTiket: String,
    images: List<Int>,
...
@Composable
fun MapsScreenpesawaran(googleMapsUrl: String) {
    // Display the map screen using the provided URL
    AndroidView(
        factory = { context ->
