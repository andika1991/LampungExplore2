...
@Composable
fun waylistApp(navController: NavHostController) {
...
@Composable
fun DaftarWisataWayKananScreen(navController: NavController) {
    ...
    Surface(
        ...
        Column(
            ...
            Text(
                text = "Daftar Wisata di Way Kanan",
                fontSize = 24.sp,
...
@Composable
fun WisataItemway(wisata: Wisata, navController: NavController) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
...
@Composable
fun MapsScreenway(googleMapsUrl: String) {
    // Display the map screen using the provided URL
    AndroidView(
        factory = { context ->
