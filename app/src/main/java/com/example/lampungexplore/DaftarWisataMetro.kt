...
@Composable
fun metrolistApp(navController: NavHostController) {
...
@Composable
fun DaftarWisataMetroScreen(navController: NavController) {
        ...
        Column(
            ...
            LazyColumn {
                items(wisataList) { wisata ->
                    WisataItemmetro(wisata = wisata, navController = navController)
                }
            }
        }
    }
...
@Composable
fun WisataItemmetro(wisata: Wisata, navController: NavController) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
...
@Composable
fun DeskripsiWisatametroScreen(
    nama: String,
    deskripsi: String,
    hargaTiket: String,
    images: List<Int>,
...
@Composable
fun MapsScreenmetro(googleMapsUrl: String) {
    // Display the map screen using the provided URL
    AndroidView(
        factory = { context ->
