...
@Composable
fun lamtimlistApp(navController: NavHostController) {
...
@Composable
fun DaftarWisataLampungTimurScreen(navController: NavController) {
    ...
    Surface(
        ...
        Column(
            ...
            Text(
                text = "Daftar Wisata di Lampung Timur",
                fontSize = 24.sp,
            ...
            LazyColumn {
                items(wisataList) { wisata ->
                    WisataItemlamtim(wisata = wisata, navController = navController)
                }
            }
        }
    }
...
@Composable
fun WisataItemlamtim(wisata: Wisata, navController: NavController) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
...
@Composable
fun DeskripsiWisatalamtimScreen(
    nama: String,
    deskripsi: String,
    hargaTiket: String,
    images: List<Int>,
...
@Composable
fun MapsScreenlamtim(googleMapsUrl: String) {
    // Display the map screen using the provided URL
    AndroidView(
        factory = { context ->
