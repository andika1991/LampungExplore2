...
@Composable
fun tubabalistApp(navController: NavHostController) {
...
@Composable
fun DaftarWisataTubabaScreen(navController: NavController) {
    ...
    Surface(
        ...
        Column(
            ...
            Text(
                text = "Daftar Wisata di Tulang Bawang Barat",
                fontSize = 24.sp,
            ...
            LazyColumn {
                items(wisataList) { wisata ->
                    WisataItemtubaba(wisata = wisata, navController = navController)
                }
            }
        }
    }
...
@Composable
fun WisataItemtubaba(wisata: Wisata, navController: NavController) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
...
@Composable
fun DeskripsiWisatatubabaScreen(
    nama: String,
    deskripsi: String,
    hargaTiket: String,
    images: List<Int>,
...
@Composable
fun MapsScreentubaba(googleMapsUrl: String) {
    // Display the map screen using the provided URL
    AndroidView(
        factory = { context ->
