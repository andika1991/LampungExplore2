...
@Composable
fun tubalistApp(navController: NavHostController) {
...
@Composable
fun DaftarWisataTulangBawangScreen(navController: NavController) {
    ...
    Surface(
        ...
        Column(
            ...
            Text(
                text = "Daftar Wisata di Tulang Bawang",
                fontSize = 24.sp,
            ...
            LazyColumn {
                items(wisataList) { wisata ->
                    WisataItemtuba(wisata = wisata, navController = navController)
                }
            }
        }
    }
...
@Composable
fun WisataItemtuba(wisata: Wisata, navController: NavController) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
...
@Composable
fun MapsScreentuba(googleMapsUrl: String) {
    // Display the map screen using the provided URL
    AndroidView(
        factory = { context ->
