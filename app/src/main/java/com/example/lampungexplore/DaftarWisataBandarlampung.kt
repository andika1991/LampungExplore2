...
@Composable
fun balamlistApp(navController: NavHostController) {
...
@Composable
fun DaftarWisataBandarLampungScreen(navController: NavController) {
    ...
    Surface(
        ...
        Column(
            ...
            Text(
                text = "Daftar Wisata di Bandar Lampung",
                fontSize = 24.sp,
            ...
            LazyColumn {
                items(wisataList) { wisata ->
                    WisataItembalam(wisata = wisata, navController = navController)
                }
            }
        }
    }
...
@Composable
fun WisataItembalam(wisata: Wisata, navController: NavController) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
...
@Composable
fun DeskripsiWisatabalamScreen(
    nama: String,
    deskripsi: String,
    hargaTiket: String,
    images: List<Int>,
...
@Composable
fun MapsScreenbalam(googleMapsUrl: String) {
    // Display the map screen using the provided URL
    AndroidView(
        factory = { context ->
